...
creaseworks is a Next.js App Router application deployed on Vercel at `windedvertigo.com/harbor/creaseworks` (basePath: `/harbor/creaseworks`). Notion is the editorial CMS; Neon Postgres is the system of record for users, organisations, entitlements, and access control. Content flows one direction: Notion → Postgres cache → app. Entitlement and identity data lives exclusively in Postgres.
...
│  windedvertigo.com/harbor/creaseworks               │
│                                                       │
...
- Deploy to `windedvertigo.com/harbor/creaseworks`
...
# app
NEXT_PUBLIC_APP_URL=https://windedvertigo.com/harbor/creaseworks
```
