...
(function () {
  ...
  function createSVGIcon() {
    ...
    svg.appendChild(circle('12', '12', '10.5', 'none', 'currentColor', '1.5'));
    svg.appendChild(circle('12', '6.5', '1.5', 'currentColor', null, null));
    svg.appendChild(path('M9 10.5h6', 'currentColor', '1.5', 'round'));
    svg.appendChild(path('M12 10.5v4', 'currentColor', '1.5', 'round'));
    svg.appendChild(path('M10 14.5l-1.5 3M14 14.5l1.5 3', 'currentColor', '1.5', 'round'));
    return svg;
  }
