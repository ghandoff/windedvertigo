/**
 * Harbour-preview footer — verbatim copy of the harbour-apps footer
 * structure, but using the site's existing `.wv-footer*` class set
 * (already defined in site/styles/main.min.css), so we don't need a
