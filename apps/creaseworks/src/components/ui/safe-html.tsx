 ...
 *
 * This component provides a clean pattern for the progressive
 * enhancement approach: if `html` is provided and non-null,
 * render it; otherwise fall back to `fallback` (plain text children).
 *
