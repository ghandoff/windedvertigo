    ...
    <main className="min-h-screen px-6 py-16 max-w-5xl mx-auto">
      <header className="mb-12">
        ...
        <p className="text-cadet/60 max-w-lg">
          browse co-design patterns at a glance. each card shows a teaser —
          unlock the full pattern, materials, and find-again prompts through a
          pack purchase.
        </p>
      </header>
      ...
      {patterns.length === 0 ? (
        <p className="text-cadet/40 text-center py-20">
          no patterns synced yet. check back soon.
        </p>
      ) : (
