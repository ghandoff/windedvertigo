...
export const metadata: Metadata = {
  ...
  description: "your pack is ready — host sessions with the full raft.",
};
    ...
    <main className="min-h-screen flex items-center justify-center px-6">
      <div className="max-w-md text-center">
        ...
        <p className="text-sm text-cadet/60 mb-6">
          {pack
            ? `you now have full access to ${pack}. host sessions, save history — it's all yours.`
            : "your purchase is complete. you now have full access to your new activity pack."}
        </p>
