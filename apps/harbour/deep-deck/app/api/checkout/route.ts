/**
 * POST /api/checkout — create a Stripe checkout session for a deep-deck pack.
 *
...
const APP_URL =
  ...
  "https://windedvertigo.com/harbour/deep-deck";
...
export async function POST(req: Request) {
  ...
  try {
    ...
    console.error("[deep-deck] checkout error:", err);
    return NextResponse.json(
