    ...
    <main id="main" className="min-h-screen flex items-center justify-center px-6">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-[var(--color-text-on-dark-muted)]">
            save your favourite cards and unlock more decks.
          </p>
        </div>
        ...
        {/* google sign-in */}
        <form action="/harbour/deep-deck/api/auth/signin/google" method="POST">
          <input type="hidden" name="callbackUrl" value={`/harbour/deep-deck${callback_url}`} />
        ...
        {/* email magic link */}
        <form action="/harbour/deep-deck/api/auth/signin/resend" method="POST" className="space-y-3">
          <input type="hidden" name="callbackUrl" value={`/harbour/deep-deck${callback_url}`} />
          <input type="hidden" name="csrfToken" value="" />
          <input
            type="email"
