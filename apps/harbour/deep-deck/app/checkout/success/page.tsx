...
export const metadata: Metadata = {
  ...
  description: "your pack is ready — unlock the full deck.",
};
    ...
    <main className="min-h-screen flex items-center justify-center px-6">
      <div className="max-w-md text-center">
        ...
        <h1 className="text-2xl font-semibold tracking-tight mb-3">
          your deck is unlocked
        </h1>

        <p className="text-sm text-cadet/60 mb-6">
          {pack
            ? `you now have full access to ${pack}. every card, every prompt — it's all yours.`
            : "your purchase is complete. you now have full access to your new deck."}
        </p>
