/**
 * POST /api/checkout — create a Stripe checkout session for a depth-chart pack.
 *
...
const APP_URL =
  ...
  "https://windedvertigo.com/harbour/depth-chart";
...
export async function POST(req: Request) {
  ...
  try {
    ...
    console.error("[depth-chart] checkout error:", err);
    return NextResponse.json(
