...
export const metadata: Metadata = {
  ...
  description: "your pack is ready — start generating assessments.",
};
    ...
    <main className="min-h-screen flex items-center justify-center px-6">
      <div className="max-w-md text-center">
        ...
        <p className="text-sm text-cadet/60 mb-6">
          {pack
            ? `you now have full access to ${pack}. generate assessments, export reports — it's all yours.`
            : "your purchase is complete. you now have full access to your new pack."}
        </p>
