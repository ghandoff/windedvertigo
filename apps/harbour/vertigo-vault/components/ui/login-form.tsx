  ...
  if (status === "sent") {
    return (
      <div className="text-center space-y-4">
        ...
        <h2 className="text-xl font-bold" style={{ color: "var(--vault-text)" }}>
          check your email
        </h2>
  ...
  return (
    <div className="space-y-6 w-full max-w-sm">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 py-3 rounded-lg border font-medium text-sm transition-colors"
        style={{
      ...
      <div className="flex items-center gap-3">
        <div className="flex-1 h-px" style={{ backgroundColor: "var(--vault-border)" }} />
        <span className="text-xs" style={{ color: "var(--vault-text-muted)" }}>or</span>
        <div className="flex-1 h-px" style={{ backgroundColor: "var(--vault-border)" }} />
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4" aria-label="sign in with email">
        ...
        {status === "error" && (
          <p id="login-error" className="text-sm" style={{ color: "#d4836f" }}>
            {errorMsg}
          </p>
        )}
        <button
