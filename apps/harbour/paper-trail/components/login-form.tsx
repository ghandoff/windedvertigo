...
export default function LoginForm({ callbackUrl }: LoginFormProps) {
  ...
  async function handleGoogleSignIn() {
    await signIn("google", {
      callbackUrl: callbackUrl || "/harbour/paper-trail",
    });
  }
  ...
  if (status === "sent") {
    return (
      <div className="text-center space-y-4">
        ...
        <h2 className="text-xl font-bold" style={{ color: "var(--color-text-on-dark)" }}>
          check your email
        </h2>
  ...
  return (
    <div className="space-y-6 w-full max-w-sm">
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-xs" style={{ color: "var(--color-text-on-dark-muted)" }}>or</span>
        <div className="flex-1 h-px" style={{ backgroundColor: "rgba(255, 255, 255, 0.15)" }} />
      </div>
