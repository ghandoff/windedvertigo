...
- [x] Standardized all 5 Next.js apps on Next.js 16 + React 19 (Mar 2026) — nordic-sqr-rct from 14/18, deep-deck/harbour/vertigo-vault from 15/19
...
- [ ] Wire harbour Next.js app to CMS JSON (replace hardcoded `GAMES` array in `game-showcase.tsx`)
