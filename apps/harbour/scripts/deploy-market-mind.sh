#!/usr/bin/env bash
# Deploy the market-mind Vercel project from the monorepo root.
#
# Usage:
#   ./scripts/deploy-market-mind.sh            # production deploy
#   ./scripts/deploy-market-mind.sh --preview  # preview deploy
...
PROJECT_ID="prj_GuekmnTckniMuX2N8UzCiDyKqKRR"
...
echo "→ Swapping .vercel/project.json to target market-mind"
...
printf '{"projectId":"%s","orgId":"%s","projectName":"market-mind"}\n' \
