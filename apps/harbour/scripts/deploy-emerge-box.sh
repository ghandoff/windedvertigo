#!/usr/bin/env bash
# Deploy the emerge-box Vercel project from the monorepo root.
#
# Usage:
#   ./scripts/deploy-emerge-box.sh            # production deploy
#   ./scripts/deploy-emerge-box.sh --preview  # preview deploy
...
PROJECT_ID="prj_CA9L0akYY9F7b0Og8I97AgkVPecx"
...
echo "→ Swapping .vercel/project.json to target emerge-box"
...
printf '{"projectId":"%s","orgId":"%s","projectName":"emerge-box"}\n' \
