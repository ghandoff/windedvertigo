    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          ...
          <Link href="/reviews/network" className="card p-5 border-l-4 border-l-gold-500 hover:shadow-md transition group">
            <div className="flex items-start gap-3">
          ...
          <Link href="/reviews/credibility" className="card p-5 border-l-4 border-l-green-500 hover:shadow-md transition group">
            <div className="flex items-start gap-3">
                  ...
                  return (
                    <div key={article.id} className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition">
                      ...
                      <div className="flex items-center justify-between mt-3">
                        ...
                        <Link
                          href={`/reviews/intake?article=${article.id}`}
