    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-2xl mx-auto px-4 py-16 text-center">
          ...
          <a href="/reviews/dashboard" className="btn-primary">Go to Dashboard</a>
        </div>
      </div>
    );
  }
              ...
              <div className="sticky top-20 max-h-[calc(100vh-8rem)] overflow-y-auto bg-white rounded-xl border border-gray-200 shadow-sm">
                ...
                <div className="p-5 space-y-5">
                  ...
                  <div className="space-y-3">
                    ...
                    {intakeData.pdf && (
                      <div>
                        <p className="form-label">PDF</p>
                        <a
                          href={intakeData.pdf}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center gap-1.5 text-sm text-pacific-600 hover:underline font-medium"
                        >
