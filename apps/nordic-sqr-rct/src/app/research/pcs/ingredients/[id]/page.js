  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2 text-sm text-gray-500">
        <Link href="/research/pcs/ingredients" className="hover:underline">Ingredients</Link>
        <span>/</span>
    ...
    return (
      <div className="card p-5">
        <div className="flex items-start justify-between gap-4">
          ...
          <Link href="/research/pcs/aics?status=Pending+RA+Review" className="text-xs text-pacific-600 hover:underline">
            See AICS queue →
          </Link>
        </div>
