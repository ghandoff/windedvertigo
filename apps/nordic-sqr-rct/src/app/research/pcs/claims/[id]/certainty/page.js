    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-2">
          <Link href="/research/pcs/claims" className="hover:underline">Claims</Link>
          <span>/</span>
          <Link href={`/research/pcs/claims/${claimId}`} className="hover:underline">
      ...
      <div className="card p-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="bg-gray-50 p-3 rounded">
            ...
            <p className="text-xs text-gray-500 mt-1">
              <Link href={`/research/pcs/claims/${claimId}/applicability`} className="text-pacific-600 hover:underline">
