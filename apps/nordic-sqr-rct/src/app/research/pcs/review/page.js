      ...
      <div className="space-y-4">
        ...
        <div className="text-center py-16 bg-white border border-gray-200 rounded-lg">
          ...
          <div className="flex justify-center gap-3 mt-6">
            <Link href="/research/pcs/claims" className="px-4 py-2 bg-pacific-600 text-white rounded-md text-sm font-medium hover:bg-pacific-700 transition-colors">
              View all claims
            </Link>
            <Link href="/research/pcs" className="px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">
              Command Center
            </Link>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <div className="flex items-start justify-between mb-4">
              ...
              <Link href={`/research/pcs/claims/${current.id}`} className="text-xs text-gray-400 hover:text-pacific-600">
                Full detail
              </Link>
            </div>
