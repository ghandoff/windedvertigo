...
export async function GET(request) {
  ...
  try {
    ...
    const name = (searchParams.get('name') || user.alias || 'Reviewer').slice(0, 200);
    const reviews = String(parseInt(searchParams.get('reviews') || '0', 10) || 0);
    const institution = (searchParams.get('institution') || '').slice(0, 200);
