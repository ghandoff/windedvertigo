  ...
  async function handleSummarize() {
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (data.description) setActivity(data.description);
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side="right" className="w-96">
        ...
        <div className="mt-6 space-y-4">
          ...
          {type === "meeting" && (
            <div>
              <Label className="mb-1.5 block">paste raw meeting notes (optional)</Label>
              <Textarea
                placeholder="paste transcript, bullet points, or stream-of-consciousness notes..."
                value={rawNotes}
