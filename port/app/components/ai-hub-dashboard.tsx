      ...
      {result && (
        <>
          ...
          {result.results.organizations.length > 0 && (
            <Card>
              <CardHeader>
                <CardTitle className="text-base">organisations ({result.results.organizations.length})</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-2">
      ...
      <Card>
        <CardContent className="py-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              AI suggests who to follow up with and what to do, based on your port data
            </p>
          </div>
