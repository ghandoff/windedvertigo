  ...
  const checks: CheckItem[] = [
    ...
    },
    {
      ...
      warning: props.audienceCount === 0 && props.addedCount === 0
        ? "no organisations in audience — add filters or manually add orgs"
        : undefined,
      detail: `${props.audienceCount + props.addedCount} organisations${props.removedCount > 0 ? ` (${props.removedCount} excluded)` : ""}`,
    },
    {
