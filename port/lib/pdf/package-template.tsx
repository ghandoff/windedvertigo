 ...
 *
 * Copied from site/lib/pdf/package-template.tsx — lives here so the
 * port (Node.js / Vercel) can render PDFs via @react-pdf/renderer.
 * The site has been migrated to CF Pages (Workers), which cannot run
 * @react-pdf/renderer. PDF generation is now owned by the port cron.
 */
...
import type { PackData } from "@/lib/notion/package-builder";
