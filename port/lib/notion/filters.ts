/**
 * Reusable Notion filter builders for port queries.
 *
...
export function buildTextEquals(property: string, value: string): NotionFilter {
...
export function buildPeopleContains(property: string, userId: string): NotionFilter {
  return { property, people: { contains: userId } };
}
