...
// The /what-v2/ development page now reads from site-content-what.json
// generated by fetchSiteContent() below.
...
async function main() {
  ...
  try {
    const [quadrants, outcomes, portfolioAssets, vaultActivities, whatPageSections, siteContent] = await Promise.all([
      fetchQuadrants(),
      fetchOutcomes(),
