...
export async function POST(req: NextRequest) {
  ...
  try {
    const result = await callClaude({
      ...
      system: `You score email subject lines for CRM outreach on a scale of 1-10. Consider: personalization, clarity, length (4-8 words ideal), urgency, and relevance. Output ONLY JSON: {"score": number, "tip": "brief improvement tip"}`,
